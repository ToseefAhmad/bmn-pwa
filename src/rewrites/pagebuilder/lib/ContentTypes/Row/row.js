...
const APPEARANCE_CONTAINED = 'contained'
const APPEARANCE_FULL_BLEED = 'full-bleed'
const APPEARANCE_FULL_WIDTH = 'full-width'
...
const Row = props => {
  ...
  if (appearance === APPEARANCE_FULL_BLEED) {
    return (
      <div
        ref={ backgroundElement }
        data-appearance={ APPEARANCE_FULL_BLEED }
        style={ dynamicStyles }
  ...
  if (appearance === APPEARANCE_FULL_WIDTH) {
    return (
      <div
        ref={ backgroundElement }
        data-appearance={ APPEARANCE_FULL_WIDTH }
        style={ dynamicStyles }
        className={ [ classes.root, ...cssClasses ].join(' ') }
      >
        { videoOverlay }
...
Row.propTypes = {
  ...
  appearance: oneOf([ APPEARANCE_CONTAINED, APPEARANCE_FULL_WIDTH, APPEARANCE_FULL_BLEED ]),
