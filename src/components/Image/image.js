...
const Image = props => {
  ...
  /**
   * @venia_update
   * Empty alt results in an error and so this is converted into 'image'
   * Solution: Replaced alt={alt} with alt={altText}
   * @returns {*}
   */
  const altText = (alt === null) ? 'image' : alt
  ...
  return (
    <div className={containerClass}>
      {actualImage ? actualImage : <PlaceholderImage
        alt={altText}
        classes={classes}
